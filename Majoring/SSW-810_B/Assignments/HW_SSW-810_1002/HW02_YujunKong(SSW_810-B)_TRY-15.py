    ...
    def get_Frac_ArraySum(self):
        ...
        def set_SecondFrac():
            ...
            def set_ExtraFrac():
                ...
                print("Please set an extra fraction...")
                BL()
                x = t.get_Cvted_InputVal("Input the numerator: ",'Int')
                y = t.get_Cvted_InputVal("Input the denominator: ",'Int')
                ...
                return soloFracArr.append(set_SecondFrac())
            
            
            initFracArr = []

            print("Please set a second fraction...")
            BL()
            x = t.get_Cvted_InputVal("Input the numerator: ",'Int')
            y = t.get_Cvted_InputVal("Input the denominator: ",'Int')
            ...
            stored_FracArrays = initFracArr
            stored_FracArrays.append(initFracArr)
            ...
            addiFracArr = []
            #initFracArr.append(addiFracArr)

            #lawfulCMD = ["c","a"]
            if altCMD == "c":
                
                print("Calculating the fractions...")
                print(stored_FracArrays)
                return stored_FracArrays
